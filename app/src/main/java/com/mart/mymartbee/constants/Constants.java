package com.mart.mymartbee.constants;
...
public interface Constants {
    ...
    public static final int REQUEST_TAKE_GALLERY_VIDEO = 5675;
    ...
    public static int STORE_CREATION_to_ADDRESS_SELECTION = 4;
    public static int ADDRESS_SELECTED = 5;
    public static int STORE_CREATION_to_HOME = 6;
    public static int MOBILE_LOGIN_to_HOME = 7;
    public static int ACCOUNT_FRAG_to_CATEGORY_SELECTION = 8;
    public static int ACCOUNT_FRAG_to_ADDRESS_SELECTION = 9;
    public static int ACCOUNT_FRAG_to_CROP_SAMPLE_ACTIVITY = 10;
    public static int CROP_success = 11;
    public static int HOME_FRAG_to_ADD_PRODUCT = 12;
    public static int PRODUCT_ADDED_success = 13;
    public static int ADD_PRODUCT_to_CROP_SAMPLE_ACTIVITY = 14;
    public static int ADD_PRODUCT_to_SUBCATE_SELECTION = 15;
    public static int SUB_CATEGORY_SELECTED = 16;
    public static int HOME_FRAG_to_PRODUCT_DETAILS = 17;
    public static int PRODUCT_DELETION_success = 18;
    public static int PRODUCT_DETAILS_to_PRODUCT_EDIT = 19;
    public static int PRODUCT_UPDATED_success = 20;
